    ...
    <section className="about_back py-5">
      <div className="container_1140">
        ...
        <Row className="pt-5">
          <Col xl={7}>
            <div
              className="back_shadow back_card ps-5 py-5 pe-4 border_about position-relative card_hover overflow-hidden"
              data-aos="fade-right"
            ...
            >
              ...
              >
                ...
                <p className="fw_400 fs_md ff_Montserrat clr_white pt-1 ps-4">
