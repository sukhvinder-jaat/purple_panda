            ...
            <Row className=" position-relative z-3">
              <Col sm={6}>
                <div className="d-flex align-items-center input_hover pointer">
                  ...
                  <p className="fw_600 fs_md ff_Montserrat clr_white ps-2 mb-0">
                    Same Day Delivery
                  </p>
                </div>
              </Col>
              <Col sm={6}>
                <div className="d-flex align-items-center pt-3 pt-sm-0 input_hover pointer">
              ...
              <Col sm={6}>
                <div className="d-flex align-items-center pt-sm-4 pt-3 input_hover pointer">
